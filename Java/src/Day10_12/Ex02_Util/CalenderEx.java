...
//		new Calendar() 대신, getInstace() 메소드로 객체를 사용한다.
		...
		lastDay.set(2025, Calendar.FEBRUARY, 11, 18, 20, 0);
		...
		// 1970년 1월 1일 ~ 오늘
		// 1970년 1월 1일 ~ 2025년 02월 11일
		long nowD = nowT / (1000 * 60 * 60 * 24);
		long lastD = lastT / (1000 * 60 * 60 * 24);
		
		System.out.println("1970년 1월 1일 ~ 오늘 : " + nowD);
		System.out.println("1970년 1월 1일 ~ 2025년 02월 11일 : " + lastD);
		
		// 내가 태어난 지 몇 일
		Calendar birth = Calendar.getInstance();
		
		birth.set(2000, Calendar.OCTOBER, 02);					// 내 생일로 날짜 지정하기
		long bornD = birth.getTimeInMillis() / (1000 * 60 * 60 * 24);	// 내 생일 ms 로 반환하고 일 단위로 변환
		long afterBirth = nowD - bornD;							// 오늘 - 생일
